...
export const PlanActionsCard = ({ plan, onFeedback }: PlanActionsCardProps) => {
  ...
  const canAccessBillingPortal = !isFreePlan;
  ...
  return (
    <>
      ...
      >
        ...
        <DialogContent>
          <Typography>
            Tem certeza que deseja cancelar seu plano {plan.name}?
          </Typography>
          <Typography variant="body2" color="text.secondary" className="mt-2">
            Você ainda terá acesso aos recursos até{" "}
            {formatDate(plan.planExpiresAt)}. Após essa data, seu plano será
            revertido para FREE.
          </Typography>
        </DialogContent>
        <DialogActions>

...
/**
 * Unified Plan Schemas
 * Supports both CANDIDATE and COMPANY tenant types
 */

// All valid plan names
const candidatePlans = ["FREE", "PRO", "PREMIUM"] as const;
const companyPlans = ["STARTUP", "BUSINESS", "ENTERPRISE"] as const;
const allPlans = [...candidatePlans, ...companyPlans] as const;

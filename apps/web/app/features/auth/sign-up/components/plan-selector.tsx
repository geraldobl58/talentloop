...
const PlanCard = ({ plan, isSelected, onSelect, disabled }: PlanCardProps) => {
    ...
    >
      ...
      <Box className="absolute top-0 right-0 flex gap-1">
        ...
        {plan.isTrial && plan.trialDays && (
          <Chip
            label={`${plan.trialDays} dias grátis`}
            size="small"
            color="success"
            sx={{
        ...
        {userType === UserType.CANDIDATE ? (
          <Typography variant="caption" className="text-gray-500">
            {value === "FREE"
              ...
              : "Você terá 7 dias de teste grátis antes da cobrança."}
          </Typography>
        ) : (
          <Typography variant="caption" className="text-gray-500">
            {value === "ENTERPRISE"
              ? "Entre em contato conosco para uma solução personalizada."
              : "Você terá 14 dias de teste grátis antes da cobrança."}
          </Typography>
        )}
      </Box>
    </Box>

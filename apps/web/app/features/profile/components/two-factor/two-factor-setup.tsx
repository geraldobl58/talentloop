              ...
              <Box className="flex items-start gap-4">
                ...
                <Box>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    ...
                    ou Authy. Disponíveis gratuitamente na App Store e Google
                    Play.
                  </Typography>
                </Box>
              </Box>
              ...
              <Box className="flex items-start gap-4">
                ...
                <Box className="flex-1">
                  ...
                  <Typography
                    ...
                    className="mb-4"
                  >
                    Digite o código de 6 dígitos (apenas números) exibido no seu
                  ...
                  <form onSubmit={enableForm.handleSubmit(onEnable)}>
                    <Box className="flex flex-col justify-center mt-8 gap-3">
                      <TextField
                        ...
                        helperText={enableForm.formState.errors.token?.message}
                        disabled={isEnabling}
                        slotProps={{
                          input: {
                            startAdornment: (
